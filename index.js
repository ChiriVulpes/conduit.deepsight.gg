...
define("utility/Log", ["require", "exports", "utility/Store"], function (require, exports, Store_1) {
    ...
    (function (Log) {
        ...
        function info(...args) {
            ...
            console[Log.VERBOSE.value ? 'info' : 'debug'](`%c${new Date().toTimeString().slice(0, 8)} %cconduit.deepsight.gg %c/`, PUNCT_FORMAT, SERVICE_FORMAT, PUNCT_FORMAT, ...args);
        }
        Log.info = info;
        function warn(...args) {
            // log with coloured prefix [conduit.deepsight.gg]
            console.warn(`%c${new Date().toTimeString().slice(0, 8)} %cconduit.deepsight.gg %c/`, WARN_FORMAT, SERVICE_FORMAT, PUNCT_FORMAT, ...args);
        }
        Log.warn = warn;
        function error(...args) {
            // log with coloured prefix [conduit.deepsight.gg]
            console.error(`%c${new Date().toTimeString().slice(0, 8)} %cconduit.deepsight.gg %c/`, ERROR_FORMAT, SERVICE_FORMAT, PUNCT_FORMAT, ...args);
        }
        Log.error = error;
    })(Log || (Log = {}));
    exports.default = Log;
...
define("model/ClarityManifest", ["require", "exports", "model/Model", "utility/Clarity"], function (require, exports, Model_1, Clarity_1) {
    ...
    exports.default = (0, Model_1.default)('ClarityManifest', {
        ...
        async fetch() {
            const manifest = await Clarity_1.default.get(`/versions.json?_=${Math.random().toString(36).slice(2)}`);
...
define("model/DestinyManifest", ["require", "exports", "model/Model", "utility/Bungie"], function (require, exports, Model_3, Bungie_1) {
    ...
    exports.default = (0, Model_3.default)('DestinyManifest', {
        cacheDirtyTime: 1000 * 60 * 60, // 1 hour cache time
        async fetch() {
            const manifest = await Bungie_1.default.get('/Destiny2/Manifest/', undefined, { cache: 'reload' });
...
define("model/CombinedManifestVersion", ["require", "exports", "model/ClarityManifest", "model/DeepsightManifest", "model/DestinyManifest", "model/Model"], function (require, exports, ClarityManifest_1, DeepsightManifest_1, DestinyManifest_1, Model_4) {
    ...
    async function getVersions(hard) {
        const [destiny, deepsight, clarity] = await Promise.all([
            DestinyManifest_1.default.use(hard),
            DeepsightManifest_1.default.use(hard),
            ClarityManifest_1.default.use(hard),
        ]);
        if (hard)
    ...
    const CombinedManifestVersion = (0, Model_4.default)('CombinedManifestVersion', {
                            ...
                            switch (prefix) {
                                ...
                                case 'deepsight': {
                                    ...
                                    return {
                                        ...
                                        value: async () => await Deepsight_2.default.get(`/${componentName}.json`, !manifest.value.isLocal),
                                    };
                                }
                                case 'clarity': {
...
define("model/ProfiledModel", ["require", "exports", "model/Model"], function (require, exports, Model_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function ProfiledModel(name, definition) {
        ...
        return {
            for(profile) {
                ...
                return cache[membershipTypeAndId] ??= (0, Model_6.default)(`${name}:${membershipTypeAndId}`, {
...
define("model/DestinyProfiles", ["require", "exports", "model/ProfiledModel", "utility/Bungie"], function (require, exports, ProfiledModel_1, Bungie_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ProfiledModel_1.ProfiledModel)('destiny2/profile', {
        ...
        async fetch(profile) {
            const profileResponse = profile && await Bungie_2.default.getForUser(`/Destiny2/${profile.type}/Profile/${profile.id}/`, {
                components: [
...
define("model/Items", ["require", "exports", "model/Categorisation", "model/Definitions", "utility/Log", "utility/Objects"], function (require, exports, Categorisation_1, Definitions_1, Log_3, Objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("model/Collections", ["require", "exports", "model/CombinedManifestVersion", "model/Definitions", "model/DestinyProfiles", "model/Items", "model/ProfiledModel"], function (require, exports, CombinedManifestVersion_1, Definitions_2, DestinyProfiles_1, Items_1, ProfiledModel_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            return {
                ...
                value: async () => {
                    const [DeepsightCollectionsDefinition, DeepsightMomentDefinition,] = await Promise.all([
                        Definitions_2.default.en.DeepsightCollectionsDefinition.get(),
                        Definitions_2.default.en.DeepsightMomentDefinition.get(),
                    ]);
...
define("model/Inventory", ["require", "exports", "model/Definitions", "model/DestinyProfiles", "model/Items", "model/ProfiledModel"], function (require, exports, Definitions_3, DestinyProfiles_2, Items_2, ProfiledModel_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const version = `1.${Items_2.ITEMS_VERSION}`;
        ...
        async fetch(profile) {
            ...
            return {
                ...
                value: async () => {
                    if (!data)
                        return undefined;
                    const [DestinyClassDefinition, DestinyInventoryBucketDefinition,] = await Promise.all([
                        Definitions_3.default.en.DestinyClassDefinition.get(),
                        Definitions_3.default.en.DestinyInventoryBucketDefinition.get(),
                    ]);
...
define("model/Profiles", ["require", "exports", "model/Definitions", "utility/Bungie", "utility/Colour", "utility/Database", "utility/Diff", "utility/Store"], function (require, exports, Definitions_4, Bungie_3, Colour_1, Database_3, Diff_1, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Profiles) {
        ...
        async function updateProfile(profile, access, destinyProfile) {
            ...
            if (guardianRank !== undefined && profile.guardianRank?.rank !== guardianRank) {
                updated = true;
                const DestinyGuardianRankDefinition = await Definitions_4.default.en.DestinyGuardianRankDefinition.get();
            ...
            if (destinyProfile?.characters) {
                updated = true;
                const emblems = await Definitions_4.default.en.DeepsightEmblemDefinition.get();
...
define("Conduit", ["require", "exports", "model/Auth", "model/Collections", "model/CombinedManifestVersion", "model/Definitions", "model/DefinitionsComponentNames", "model/Inventory", "model/Profiles", "utility/Database", "utility/Env", "utility/FilterHelper", "utility/Service", "utility/Store"], function (require, exports, Auth_2, Collections_1, CombinedManifestVersion_2, Definitions_5, DefinitionsComponentNames_1, Inventory_1, Profiles_1, Database_4, Env_3, FilterHelper_1, Service_1, Store_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const service = (0, Service_1.default)({
        ...
        async onActivate(service, event) {
            console.log(await Definitions_5.default.en.DestinySeasonDefinition.get());
        },
        onRegistered(service) {
            void service.broadcast.ready();
            (0, Store_4.onUpdateStore)(key => {
        ...
        onCall: {
            ...
            async getProfile(event, displayName, displayNameCode) {
                const profile = await Profiles_1.default.searchDestinyPlayerByBungieName(displayName, displayNameCode);
            ...
            async bumpProfile(event, displayName, displayNameCode) {
                await Profiles_1.default.searchDestinyPlayerByBungieName(displayName, displayNameCode);
            },
            //#endregion
            ////////////////////////////////////
            async getCollections(event, displayName, displayNameCode) {
                const profile = _
                    ...
                    ?? await Profiles_1.default.getCurrentProfile(undefined);
            ...
            async getInventory(event, displayName, displayNameCode) {
                ...
                return profile && await Inventory_1.default.for(profile).get();
            },
            ...
            async _getSetting(event, key) {
                ...
                return await Store_4.default[key].get();
            },
            async _setSetting(event, key, value) {
                if (event.origin !== self.origin)
                    throw new ConduitPrivateFunctionError();
                await Store_4.default[key].set(value);
            },
            async _resetSetting(event, key) {
                if (event.origin !== self.origin)
                    throw new ConduitPrivateFunctionError();
                await Store_4.default[key].delete();
            },
            //#endregion
            ////////////////////////////////////
            setOrigin(event) { },
            ...
            async _setCustomApp(event, app) {
                if (event.origin !== self.origin)
                    throw new ConduitPrivateFunctionError();
                if (app)
                    await Store_4.default.customApp.set(app);
                else
                    await Store_4.default.customApp.delete();
                await Store_4.default.auth.delete(); // must re-auth when changing app
            },
            ...
            async _grantAccess(event, origin, appName) {
                if (event.origin !== self.origin)
                    throw new ConduitPrivateFunctionError();
                const granted = await Auth_2.default.grantAccess(origin, appName);
                if (granted) {
            ...
            async _getDefinition(event, language, component, hash) {
                const defs = await Definitions_5.default[language][component].get();
                return defs[hash];
            },
            async _getDefinitionsComponent(event, language, component, filter) {
                if (filter?.evalExpression && !await Auth_2.default.isOriginTrusted(event.origin))
            ...
            async _getDefinitionsComponentPage(event, language, component, pageSize, page, filter) {
                ...
                if (filter?.evalExpression && !await Auth_2.default.isOriginTrusted(event.origin))
                    throw new ConduitFunctionRequiresTrustedOriginError();
                // filter.evalExpression = undefined
                let defs = await Definitions_5.default[language][component].get();
                let filtered = false;
                if (filter && (filter.nameContainsOrHashIs || filter.deepContains || filter.jsonPathExpression || filter.evalExpression)) {
                    filtered = true;
            ...
            async _getDefinitionLinks(event, language, component, hash) {
                ...
                if (!def)
                    return undefined;
                const { components, enums } = await Definitions_5.default.en.DeepsightLinksDefinition.get();
                ...
                await Promise.all([
                    ...(linksDef.augmentations ?? [])
                        ...
                        const defs = await Definitions_5.default[language][augmentationComponent].get();
                        const def = defs?.[hash];
                        if (!def)
                            return;
                        augmentations ??= {};
                    ...
                    component !== 'DestinyInventoryItemDefinition' ? undefined : (async () => {
                        const DeepsightVariantDefinition = await Definitions_5.default[language].DeepsightVariantDefinition.get();
                        ...
                        await Promise.all(variants.map(async (variantEntry) => {
                            const defs = await Definitions_5.default[language].DestinyInventoryItemDefinition.get();
                            definitions ??= {};
            ...
            async _getDefinitionsReferencingPage(event, language, component, hash, pageSize, page) {
                const { components } = await Definitions_5.default.en.DeepsightLinksDefinition.get();
                ...
                await Promise.all(componentsReferencing.map(async ([referencingComponent, linksDef]) => {
                    ...
                    const defs = await Definitions_5.default[language][referencingComponent].get();
    ...
    async function updateProfiles(forceOriginUpdate) {
        ...
        if (!profile) {
            profile = await Profiles_1.default.getCurrentProfile(auth);
            if (profile) {
                updated = true;
