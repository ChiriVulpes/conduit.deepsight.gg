...
/* eslint-disable no-undef, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access */
...
define("utility/Network", ["require", "exports", "utility/Store"], function (require, exports, Store_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Network) {
        async function fetch(input, init) {
            ...
            if (blockedOrigins.has(url.origin) && await Store_2.default.simulateOfflineApi.get()) {
...
define("model/Auth", ["require", "exports", "utility/Env", "utility/Log", "utility/Network", "utility/Store"], function (require, exports, Env_1, Log_1, Network_1, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Env_1 = __importDefault(Env_1);
    Log_1 = __importDefault(Log_1);
    Network_1 = __importDefault(Network_1);
    ...
    (function (Auth) {
        ...
        async function getAuthState() {
            const [auth, customApp, accessGrants] = await Promise.all([
                Store_3.default.auth.get(),
                Store_3.default.customApp.get(),
                getOriginGrants(),
            ]);
        ...
        async function getAPIKey() {
            const customApp = await Store_3.default.customApp.get();
        ...
        async function getValid() {
            const auth = await Store_3.default.auth.get();
            if (!auth)
                return undefined;
            ...
            const tokenResponse = await Network_1.default.fetch('https://www.bungie.net/Platform/App/OAuth/Token/', {
                method: 'POST',
                headers: {
                ...
                .then(res => res.json())
                .catch(err => {
                Log_1.default.warn('Unable to refresh Bungie.net access token', err);
                return undefined;
            });
            if (!tokenResponse)
                return undefined;
        ...
        async function handleTokenResponse(requestTime, tokenResponse) {
            ...
            await Store_3.default.auth.set(auth);
            return auth;
        }
        const empyHeaders = {
    ...
    function Model(id, def) {
        ...
        return Object.assign(def, {
            ...
            async getCached(onUpdate) {
                const cached = await Database_2.db.data.get(id).then(data => data?.data);
                if (cached === undefined)
            ...
            async getCachedVersioned(cacheVersion, onUpdate) {
                ...
                await Database_2.db.transaction('r', Database_2.db.versions, Database_2.db.data, async (db) => {
                    ...
                    cached = await db.data.get(id).then(data => data?.data);
                });
        ...
        async function versionedResponse(result, cacheVersion) {
...
define("utility/Clarity", ["require", "exports", "utility/Network"], function (require, exports, Network_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Network_2 = __importDefault(Network_2);
    var Clarity;
    (function (Clarity) {
        ...
        async function get(url) {
            if (!url.startsWith('/'))
                url = `/${url}`;
            return Network_2.default.fetch(`${origin}${url}`)
...
define("utility/Deepsight", ["require", "exports", "utility/Env", "utility/Network"], function (require, exports, Env_2, Network_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Env_2 = __importDefault(Env_2);
    Network_3 = __importDefault(Network_3);
    var Deepsight;
    (function (Deepsight) {
        ...
        function fetchTryLocalThenRemote(url, skipLocal = false) {
            const promise = (async () => {
                ...
                return await Network_3.default.fetch(`${origin}${url}`)
                    .then(handleDeepsightResponse);
            })();
            return promise;
        }
...
define("utility/Bungie", ["require", "exports", "model/Auth", "utility/Log", "utility/Network"], function (require, exports, Auth_1, Log_2, Network_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Auth_1 = __importDefault(Auth_1);
    Log_2 = __importDefault(Log_2);
    Network_4 = __importDefault(Network_4);
    var Jsonable;
    (function (Jsonable) {
    ...
    (function (Bungie) {
        ...
        async function get(url, body, options) {
            return await queue(() => request('GET', url, body, async () => await Auth_1.default.getHeaders(), options));
        }
        Bungie.get = get;
        async function getForUser(url, body) {
            return await queue(() => request('GET:AUTHED', url, body, async () => await Auth_1.default.getAuthedHeaders()));
        }
        Bungie.getForUser = getForUser;
        async function post(url, body) {
            return await queue(() => request('POST', url, undefined, async () => await Auth_1.default.getHeaders(), {
                method: 'POST',
        ...
        async function postForUser(url, body) {
            return await queue(() => request('POST:AUTHED', url, undefined, async () => await Auth_1.default.getAuthedHeaders(), {
                method: 'POST',
                body: JSON.stringify(body),
            }));
        }
        ...
        (function (action) {
            async function postForUser(url, body) {
                return await request('POST:AUTHED:ACTION', url, undefined, async () => await Auth_1.default.getAuthedHeaders(), {
                    method: 'POST',
                    body: JSON.stringify(body),
                });
            }
            action.postForUser = postForUser;
        })(action = Bungie.action || (Bungie.action = {}));
        async function request(label, url, body, headers, options) {
            if (!url.startsWith('/'))
                url = `/${url}`;
            if (body)
                url = `${url}?${mergeSearchParams(url, body)}`;
            Log_2.default.info(label, url);
            const resolvedHeaders = await headers();
            return Network_4.default.fetch(`${origin}${url}`, {
                ...options,
...
define("utility/Popularityreport", ["require", "exports", "utility/Network"], function (require, exports, Network_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Network_5 = __importDefault(Network_5);
    var Popularityreport;
    (function (Popularityreport) {
        const origin = 'https://definition.deepsight.gg';
        async function get(url) {
            return getText(url)
                .then(handlePopularityreportResponse);
        }
        Popularityreport.get = get;
        async function getText(url) {
            if (!url.startsWith('/'))
                url = `/${url}`;
            return Network_5.default.fetch(`${origin}${url}`)
                .then(response => response.text());
        }
        Popularityreport.getText = getText;
        function handlePopularityreportResponse(text) {
            return JSON.parse(text);
        }
    })(Popularityreport || (Popularityreport = {}));
    exports.default = Popularityreport;
});
define("model/Definitions", ["require", "exports", "model/ClarityManifest", "model/DeepsightManifest", "model/DestinyManifest", "model/Model", "utility/Broadcast", "utility/Clarity", "utility/Deepsight", "utility/Network", "utility/Popularityreport"], function (require, exports, ClarityManifest_1, DeepsightManifest_1, DestinyManifest_1, Model_4, Broadcast_4, Clarity_2, Deepsight_2, Network_6, Popularityreport_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Network_6 = __importDefault(Network_6);
    Popularityreport_1 = __importDefault(Popularityreport_1);
                        ...
                        async fetch() {
                            switch (prefix) {
                                case 'destiny2': {
                                    ...
                                    return {
                                        ...
                                        value: async () => {
                                            ...
                                            return Broadcast_4.default.operation('Downloading definitions', () => Network_6.default.fetch(`https://www.bungie.net${componentURI}`)
                                ...
                                case 'popularityreport': {
                                    ...
                                    const reportText = await Popularityreport_1.default.getText(filename);
                                    const report = JSON.parse(reportText);
                                    const version = hashText(reportText);
                                    return {
                                        version,
                                        value: toPopularityreportDefinitions(report),
                                    };
                                }
                                default:
    ...
    function toPopularityreportDefinitions(report) {
...
define("model/DestinyProfileComponents", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DESTINY_PROFILE_CONDUIT_COMPONENTS = exports.DESTINY_PROFILE_CACHE_COMPONENTS = void 0;
    exports.DESTINY_PROFILE_CACHE_COMPONENTS = [
    ...
    exports.DESTINY_PROFILE_CONDUIT_COMPONENTS = [
        100 /* DestinyComponentType.Profiles */,
        200 /* DestinyComponentType.Characters */,
        104 /* DestinyComponentType.ProfileProgression */,
        206 /* DestinyComponentType.CharacterLoadouts */,
...
define("model/DestinyProfileFull", ["require", "exports", "model/DestinyProfileComponents", "model/ProfiledModel", "utility/Broadcast", "utility/Bungie", "utility/Database"], function (require, exports, DestinyProfileComponents_1, ProfiledModel_1, Broadcast_5, Bungie_2, Database_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.fullProfileCacheKey = fullProfileCacheKey;
    exports.getCachedFullProfile = getCachedFullProfile;
    Broadcast_5 = __importDefault(Broadcast_5);
    Bungie_2 = __importDefault(Bungie_2);
    function fullProfileCacheKey(profile) {
        return `destiny2/profile-full:${profile.type}/${profile.id}`;
    }
    async function getCachedFullProfile(profile) {
        return await Database_3.db.data.get(fullProfileCacheKey(profile)).then(data => data?.data);
    }
    exports.default = (0, ProfiledModel_1.ProfiledModel)('destiny2/profile-full', {
        ...
        async fetch(profile) {
            const profileResponse = profile && await Broadcast_5.default.operation('Fetching Destiny profile', () => Bungie_2.default.getForUser(`/Destiny2/${profile.type}/Profile/${profile.id}/`, {
                components: DestinyProfileComponents_1.DESTINY_PROFILE_CACHE_COMPONENTS,
            }));
            return {
...
define("model/DestinyProfiles", ["require", "exports", "model/DestinyProfileComponents", "model/DestinyProfileFull", "model/ProfiledModel", "utility/Broadcast", "utility/Bungie", "utility/Store"], function (require, exports, DestinyProfileComponents_2, DestinyProfileFull_1, ProfiledModel_2, Broadcast_6, Bungie_3, Store_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isProfilePatchRecord = isProfilePatchRecord;
    exports.profilePatchRecordTime = profilePatchRecordTime;
    exports.profilePatchRecordOverrides = profilePatchRecordOverrides;
    exports.normaliseProfilePatchRecords = normaliseProfilePatchRecords;
    Broadcast_6 = __importDefault(Broadcast_6);
    Bungie_3 = __importDefault(Bungie_3);
    Store_4 = __importDefault(Store_4);
    function isProfilePatchRecord(entry) {
        return 'overrides' in entry && Array.isArray(entry.overrides);
    }
    function profilePatchRecordTime(entry) {
        return isProfilePatchRecord(entry) ? entry.time : entry.time;
    }
    function profilePatchRecordOverrides(entry) {
        return isProfilePatchRecord(entry) ? entry.overrides : [entry];
    }
    function normaliseProfilePatchRecords(entries) {
    ...
    exports.default = (0, ProfiledModel_2.ProfiledModel)('destiny2/profile', {
        cacheDirtyTime: 1000 * 30, // 30 second cache time
        async fetch(profile) {
            let profileResponse;
            if (profile) {
                try {
                    profileResponse = await Broadcast_6.default.operation('Fetching Destiny profile', () => Bungie_3.default.getForUser(`/Destiny2/${profile.type}/Profile/${profile.id}/`, {
                        components: DestinyProfileComponents_2.DESTINY_PROFILE_CONDUIT_COMPONENTS,
                    }));
                }
                catch (err) {
                    profileResponse = await (0, DestinyProfileFull_1.getCachedFullProfile)(profile);
                    if (!profileResponse)
                        throw err;
        ...
        async tweak(value, profile) {
            const allOverrides = await Store_4.default.destinyProfileOverrides.get();
            ...
            await Store_4.default.destinyProfileOverrides.set(allOverrides);
        },
    });
...
define("model/Items", ["require", "exports", "model/Categorisation", "model/Definitions", "utility/Arrays", "utility/Broadcast", "utility/Log", "utility/Objects"], function (require, exports, Categorisation_1, Definitions_1, Arrays_1, Broadcast_7, Log_3, Objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Items) {
        ...
        async function provider(profile, type) {
            ...
            DeepsightDropTableDefinition, DeepsightFormattedClarityDescriptions, DeepsightItemDamageTypesDefinition, DeepsightItemSourceDefinition, DeepsightItemSourceListDefinition, DeepsightMomentDefinition, DeepsightPlugCategorisation, DeepsightSocketCategorisation, DeepsightSocketExtendedDefinition, DeepsightStats, DeepsightTierTypeDefinition, DeepsightWeaponFoundryDefinition, DestinyDamageTypeDefinition, DestinyEquipableItemSetDefinition, DestinyEventCardDefinition, DestinyInventoryItemDefinition, DestinyPlugSetDefinition, DestinyPresentationNodeDefinition, DestinySandboxPerkDefinition, DestinySocketCategoryDefinition, DestinyStatDefinition, DestinyStatGroupDefinition,] = await Promise.all([
                ...
                Definitions_1.default.en.DeepsightDropTableDefinition.get(),
                Definitions_1.default.en.DeepsightFormattedClarityDescriptions.get(),
                Definitions_1.default.en.DeepsightItemDamageTypesDefinition.get(),
                Definitions_1.default.en.DeepsightItemSourceDefinition.get(),
                Definitions_1.default.en.DeepsightItemSourceListDefinition.get(),
                Definitions_1.default.en.DeepsightMomentDefinition.get(),
                Definitions_1.default.en.DeepsightPlugCategorisation.get(),
                Definitions_1.default.en.DeepsightSocketCategorisation.get(),
                Definitions_1.default.en.DeepsightSocketExtendedDefinition.get(),
                Definitions_1.default.en.DeepsightStats.get(),
                Definitions_1.default.en.DeepsightTierTypeDefinition.get(),
                Definitions_1.default.en.DeepsightWeaponFoundryDefinition.get(),
                Definitions_1.default.en.DestinyDamageTypeDefinition.get(),
                Definitions_1.default.en.DestinyEquipableItemSetDefinition.get(),
                Definitions_1.default.en.DestinyEventCardDefinition.get(),
                Definitions_1.default.en.DestinyInventoryItemDefinition.get(),
                Definitions_1.default.en.DestinyPlugSetDefinition.get(),
                Definitions_1.default.en.DestinyPresentationNodeDefinition.get(),
                Definitions_1.default.en.DestinySandboxPerkDefinition.get(),
                Definitions_1.default.en.DestinySocketCategoryDefinition.get(),
                Definitions_1.default.en.DestinyStatDefinition.get(),
                Definitions_1.default.en.DestinyStatGroupDefinition.get(),
            ]);
            const perks = {};
            ...
            function item(hash, def) {
                ...
                if (!item.momentHash && def.iconWatermark && !def.plug) {
                    ...
                    Broadcast_7.default.warning('conduit', 'Item has watermark but no moment', [{ is: 'item-reference', itemHash: item.hash }]);
                }
                if (def.plug)
                    plug(hash);
                items[hash] = item;
...
define("model/Inventory", ["require", "exports", "model/Definitions", "model/DestinyProfiles", "model/Items", "model/ProfiledModel", "utility/Broadcast", "utility/Colour", "utility/Store"], function (require, exports, Definitions_2, DestinyProfiles_1, Items_1, ProfiledModel_3, Broadcast_8, Colour_1, Store_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Definitions_2 = __importDefault(Definitions_2);
    DestinyProfiles_1 = __importStar(DestinyProfiles_1);
    ...
    const version = `8.${Items_1.ITEMS_VERSION}`;
    async function profileOverrideVersion(profileId) {
        const records = (0, DestinyProfiles_1.normaliseProfilePatchRecords)((await Store_5.default.destinyProfileOverrides.get())?.[profileId ?? '']);
        if (!records.length)
            return '0';
        ...
        async fetch(profile) {
            ...
            return {
                ...
                value: async () => {
                    if (!data)
                        return undefined;
                    return await Broadcast_8.default.operation('Resolving inventory', async () => {
                        const [DestinyClassDefinition, DestinyInventoryBucketDefinition, DeepsightEmblemDefinition, 
                        // DeepsightSocketCategorisation,
                        DestinyRecordDefinition, DestinySocketTypeDefinition,] = await Promise.all([
                            Definitions_2.default.en.DestinyClassDefinition.get(),
                            Definitions_2.default.en.DestinyInventoryBucketDefinition.get(),
                            Definitions_2.default.en.DeepsightEmblemDefinition.get(),
                            // Definitions.en.DeepsightSocketCategorisation.get(),
                            Definitions_2.default.en.DestinyRecordDefinition.get(),
                            Definitions_2.default.en.DestinySocketTypeDefinition.get(),
                        ]);
                        ...
                        const provider = await Items_1.default.provider(data, 'instance');
                        ...
                        return {
                            ...
                            characters: characters.toObject(character => [character.characterId, {
                                    ...
                                    emblem: !character.emblemHash ? undefined : {
                                        ...
                                        background: Colour_1.default.fromDestiny(DeepsightEmblemDefinition[character.emblemHash].backgroundColor),
    ...
    function characterTitle(character, DestinyRecordDefinition) {
...
define("model/ProfilePatch", ["require", "exports", "utility/Log", "utility/Store"], function (require, exports, Log_4, Store_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ProfilePatch = void 0;
    Log_4 = __importDefault(Log_4);
    ...
    class ProfilePatch {
        ...
        constructor(definition) {
            ...
            if (ProfilePatch.registry.some(patch => patch.id === this.id))
                Log_4.default.error(`Duplicate ProfilePatch id registered: ${this.id}`);
            ProfilePatch.registry.push(this);
        }
        async apply(profile, params, context = {}) {
            const profileOverrides = await Store_6.default.destinyProfileOverrides.get() ?? {};
            ...
            await Store_6.default.destinyProfileOverrides.set(profileOverrides);
            await this.dispatchApply(profile, record, context);
            return record;
        }
        async dispatchApply(profile, record, context = {}) {
...
define("model/Profiles", ["require", "exports", "model/Definitions", "utility/Broadcast", "utility/Bungie", "utility/Colour", "utility/Database", "utility/Diff", "utility/Store"], function (require, exports, Definitions_3, Broadcast_9, Bungie_4, Colour_2, Database_4, Diff_1, Store_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Store_7 = __importDefault(Store_7);
    var Profiles;
    (function (Profiles) {
        const version = '10';
        ...
        async function get() {
            ...
            await Broadcast_9.default.operation('Updating player profiles', () => Promise.all(profiles.map(async (profile) => {
        ...
        async function searchDestinyPlayerByBungieName(displayName, displayNameCode) {
            const profile = await Database_4.db.profiles.get({ name: displayName, code: displayNameCode });
            if (profile) {
                await touchProfileAccess(profile);
                scheduleProfileUpdate(profile);
                return profile;
            }
            return await Broadcast_9.default.operation('Searching Destiny players', () => Bungie_4.default.post('/Destiny2/SearchDestinyPlayerByBungieName/-1/', {
                displayName,
                displayNameCode,
            }).then(resolveProfile));
        }
        ...
        async function getCurrentProfile(auth) {
            if (!auth)
                return undefined;
            return await Broadcast_9.default.operation('Updating your player profile', async () => {
                ...
                const profiles = await Database_4.db.profiles.toArray();
                const userMembershipData = await Bungie_4.default.getForUser('/User/GetMembershipsForCurrentUser/');
        ...
        async function getCurrentProfileFromCache(auth) {
            if (auth.profileId) {
                const profile = await Database_4.db.profiles.get(auth.profileId);
                if (profile && (!auth.profileType || profile.type === auth.profileType))
                    return profile;
            }
            if (auth.displayName !== undefined && auth.displayNameCode !== undefined)
                return await Database_4.db.profiles.get({ name: auth.displayName, code: auth.displayNameCode });
            return undefined;
        }
        async function touchProfileAccess(profile) {
            profile.lastAccess = new Date().toISOString();
            await Database_4.db.profiles.put(profile);
        }
        function scheduleProfileUpdate(profile) {
            if (pendingProfileUpdates.has(profile.id))
                return;
            const updatePromise = new Promise(resolve => setTimeout(resolve))
                .then(() => Broadcast_9.default.operation('Updating player profiles', () => updateProfile(profile)))
                .catch(console.error)
        ...
        async function updateAuthProfile(auth, profile) {
            if (!profile)
                return;
            if (auth.displayName === profile.name
            ...
            auth.profileId = profile.id;
            auth.profileType = profile.type;
            await Store_7.default.auth.set(auth);
        }
        ...
        async function getDestinyProfile(membershipType, membershipId) {
            ...
            return Bungie_4.default.getForUser(`/Destiny2/${membershipType}/Profile/${membershipId}/?components=${components.join(',')}`)
                .catch(() => undefined);
        }
        async function updateProfile(profile, access, destinyProfile) {
            ...
            if (guardianRank !== undefined && profile.guardianRank?.rank !== guardianRank) {
                updated = true;
                const DestinyGuardianRankDefinition = await Definitions_3.default.en.DestinyGuardianRankDefinition.get();
            ...
            if (destinyProfile?.characters) {
                ...
                const [emblems, DestinyRecordDefinition] = await Promise.all([
                    Definitions_3.default.en.DeepsightEmblemDefinition.get(),
                    Definitions_3.default.en.DestinyRecordDefinition.get(),
                ]);
                const newChars = Object.values(destinyProfile.characters.data ?? {})
                    ...
                    emblem: !character.emblemHash ? undefined : {
                        ...
                        background: Colour_2.default.fromDestiny(emblems[character.emblemHash].backgroundColor),
        ...
        async function getUserClan(profile) {
            return Bungie_4.default.get(`/GroupV2/User/${profile.type}/${profile.id}/${0 /* GroupsForMemberFilter.All */}/${1 /* GroupType.Clan */}/`)
...
define("utility/Service", ["require", "exports", "utility/Log"], function (require, exports, Log_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SKIP_CLIENT = void 0;
    Log_5 = __importDefault(Log_5);
                ...
                return async (data, options) => {
                    ...
                    await Promise.all(clients.map(async (client) => {
                        try {
                            ...
                            delivery.failed++;
                            Log_5.default.warn('Broadcast delivery failed', type, `client=${client.id}`, err);
                        }
                    }));
                    if (clients.length && delivery.delivered === 0)
                        Log_5.default.info('Broadcast delivered to no clients', type, `clients=${clients.length}`, `delivered=${delivery.delivered}`, `skipped=${delivery.skipped}`, `missingOrigin=${delivery.missingOrigin}`, `failed=${delivery.failed}`);
                };
            },
        }),
    });
        ...
        service.onCall = async (event) => {
            ...
            if (id === 'global' && type === 'resolve:_getOrigin') {
                if (Array.isArray(data) && typeof data[0] === 'string')
                    awaitingOrigins.get(event.source.id)?.resolve(data[0]);
                return;
            }
    ...
    function postResponse(event, message) {
        try {
            event.source?.postMessage(message);
            return true;
        }
        catch (err) {
            Log_5.default.warn('Service response postMessage failed', message.type, `id=${message.id}`, err);
            return false;
        }
    }
    exports.default = Service;
});
define("action/ItemTransfer", ["require", "exports", "model/Auth", "model/Definitions", "model/Inventory", "model/ProfilePatch", "model/Profiles", "utility/Broadcast", "utility/Bungie", "utility/Service"], function (require, exports, Auth_2, Definitions_4, Inventory_1, ProfilePatch_1, Profiles_1, Broadcast_10, Bungie_5, Service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Bungie_5 = __importDefault(Bungie_5);
    const CharacterInventoryToVaultPatch = new ProfilePatch_1.ProfilePatch({
        ...
        fromParams: (params, time) => [
            ...
            bucketHashWhereOverride({
                item: params.item,
                location: params.to,
                bucketHash: 138197802 /* InventoryBucketHashes.General */,
            }, time),
        ],
        toParams: record => movementFromRecord(record, 'character-inventory-to-vault', override => ({ container: 'characterInventory', characterId: override.type === 'move-where' ? override.fromArrayPath[2] : '' }), () => ({ container: 'vault' })),
        onApply: (profile, params, _record, context) => broadcastInventoryPatches(profile, movementInventoryPatches(params), context),
    });
    const VaultToCharacterInventoryPatch = new ProfilePatch_1.ProfilePatch({
        ...
        toParams: record => movementFromRecord(record, 'vault-to-character-inventory', () => ({ container: 'vault' }), override => ({ container: 'characterInventory', characterId: override.type === 'move-where' ? override.toArrayPath[2] : '' })),
        onApply: (profile, params, _record, context) => broadcastInventoryPatches(profile, movementInventoryPatches(params), context),
    });
    const PostmasterBucketCorrectionPatch = new ProfilePatch_1.ProfilePatch({
    ...
    const ProfileInventoryBucketCorrectionPatch = new ProfilePatch_1.ProfilePatch({
    ...
    const EquipItemOnCharacterPatch = new ProfilePatch_1.ProfilePatch({
    ...
    function singleOverride(record, id) {
        if (record.id !== id || record.overrides.length !== 1)
            return undefined;
        return record.overrides[0];
    }
    function movementFromRecord(record, id, from, to) {
        if (record.id !== id)
            return undefined;
        let movement;
        ...
        for (const override of record.overrides) {
            if (override.type === 'move-where') {
                movement ??= movementFromOverride(override, from(override), to(override));
                continue;
            }
    ...
    function equipItemOnCharacterOverrides(params, time = Date.now()) {
        return [
    ...
    function equipItemOnCharacterFromRecord(record) {
        ...
        for (const override of record.overrides) {
            ...
            if (from?.container === 'characterInventory' && to?.container === 'characterEquipment' && from.characterId === to.characterId) {
                movement = movementFromOverride(override, from, to);
            }
        }
    ...
    function itemFromMatcher(where) {
    ...
    function valueForWherePath(conditions, path) {
        return conditions.find(condition => isWherePath(condition, path))?.value;
    }
    function isWherePath(condition, path) {
        return 'path' in condition && arrayEquals(condition.path, path);
    }
    function moveWhereOverride(params, time = Date.now()) {
        return {
            type: 'move-where',
    ...
    function movementFromOverride(override, from, to) {
        if (override.type !== 'move-where')
            return undefined;
    ...
    function bucketHashWhereOverride(params, time = Date.now()) {
        return {
            type: 'set-where',
    ...
    function bucketHashWhereFromOverride(override) {
    ...
    function postmasterBucketCorrectionFromOverride(override) {
    ...
    function broadcastInventoryPatch(profile, patch, context) {
        return broadcastInventoryPatches(profile, [patch], context);
    }
    function broadcastInventoryPatches(profile, patches, context) {
    ...
    function movementInventoryPatches(params) {
        return [
    ...
    function locationItemsPath(location) {
    ...
    function locationFromItemsPath(path) {
    ...
    function itemReferencesEqual(a, b) {
        return a.instanceId === b.instanceId
            && a.itemHash === b.itemHash
            && a.stackSize === b.stackSize
            && a.bucketHash === b.bucketHash;
    }
    function itemReferenceFromTransferBody(body) {
        return {
    ...
    function itemReferenceFromItem(item) {
        return {
    ...
    function relatedCharacter(characterId) {
        return characterId ? [{ is: 'character-reference', characterId }] : [];
    }
    function relatedTransferBody(body) {
        return [
    ...
    async function transferItem(profile, body, context = {}) {
        await Broadcast_10.default.operation(body.transferToVault ? 'Transferring item to vault' : 'Transferring item to character', relatedTransferBody(body), async () => {
            await Bungie_5.default.action.postForUser('/Destiny2/Actions/Items/TransferItem/', body);
            ...
            if (itemInventoryBucket?.isAccountScopedTransferBucket)
                await ProfileInventoryBucketCorrectionPatch.apply(profile, {
                    ...
                    fromBucketHash: body.transferToVault ? itemInventoryBucket.bucketHash : 138197802 /* InventoryBucketHashes.General */,
                    bucketHash: body.transferToVault ? 138197802 /* InventoryBucketHashes.General */ : itemInventoryBucket.bucketHash,
                }, context);
    ...
    async function getItemInventoryBucketHash(itemHash) {
        return await getItemInventoryBucket(itemHash).then(bucket => bucket?.bucketHash);
    }
    async function getItemInventoryBucket(itemHash) {
        const [DestinyInventoryItemDefinition, DestinyInventoryBucketDefinition] = await Promise.all([
            Definitions_4.default.en.DestinyInventoryItemDefinition.get(),
            Definitions_4.default.en.DestinyInventoryBucketDefinition.get(),
        ]);
        ...
        return bucketHash === undefined || !bucket ? undefined : {
            bucketHash,
            isAccountScopedTransferBucket: bucket.hasTransferDestination && bucket.scope === 1 /* BucketScope.Account */,
        };
    }
    function broadcastIntent(origin, data) {
    ...
    function broadcastFailure(origin, operationId, failedStep, err, options = {}, recoveryResult = 'not-attempted', finalBestKnownState) {
    ...
    function broadcastComplete(origin, operationId, actions) {
    ...
    function interpretFailureReason(err) {
    ...
    async function runTransferOperation(origin, operationId, failedStep, options, action) {
        try {
    ...
    async function pullFromPostmaster(profile, body, context = {}) {
        const itemDef = await Definitions_4.default.en.DestinyInventoryItemDefinition.get().then(DestinyInventoryItemDefinition => DestinyInventoryItemDefinition[body.itemReferenceHash]);
        if (!itemDef.inventory?.bucketTypeHash) {
            Broadcast_10.default.warning('user', 'Unable to pull item from postmaster: Unknown item');
            return;
        }
        const bucketHash = itemDef.inventory.bucketTypeHash;
        await Broadcast_10.default.operation('Pulling item from postmaster', relatedTransferBody(body), async () => {
            await Bungie_5.default.action.postForUser('/Destiny2/Actions/Items/PullFromPostmaster/', body);
    ...
    async function equipItem(profile, characterId, item, context = {}) {
        if (!item.instanceId) {
            Broadcast_10.default.warning('user', 'Unable to equip item: Instance required');
            throw new Error('Unable to equip item: Instance required');
        }
        await Broadcast_10.default.operation('Equipping item', [relatedItem(item), ...relatedCharacter(characterId)], async () => {
            await Bungie_5.default.action.postForUser('/Destiny2/Actions/Items/EquipItem/', {
    ...
    const EMPTY_PLAN = { type: 'series', nodes: [] };
    function step(step) {
        return { type: 'step', step };
    }
    function series(...nodes) {
        return { type: 'series', nodes: nodes.filter((node) => !!node && !isEmptyPlan(node)) };
    }
    function parallel(...nodes) {
        const filtered = nodes.filter(node => node && !isEmptyPlan(node));
        return filtered.length <= 1 ? filtered[0] ?? EMPTY_PLAN : { type: 'parallel', nodes: filtered };
    }
    function isEmptyPlan(node) {
        return node.type === 'series' && !node.nodes.length;
    }
    async function createPlannerState(profile, operationId, origin) {
        const [inventory, itemDefs, bucketDefs] = await Promise.all([
            Inventory_1.default.for(profile).get(),
            Definitions_4.default.en.DestinyInventoryItemDefinition.get(),
            Definitions_4.default.en.DestinyInventoryBucketDefinition.get(),
        ]);
        if (!inventory)
    ...
    async function executePlan(state, node) {
        switch (node.type) {
            case 'series':
    ...
    async function recoverExecutedSteps(state) {
        let attempted = false;
    ...
    function plannerStepErrorLabel(err, fallback) {
        return err instanceof TransferPlannerError ? err.message : fallback;
    }
    function compileVaultRoute(state, item) {
        ...
        return series(prepared.plan, ensureVaultSpace(state), transferToVaultStep(referenceFromPlannerItem(prepared.item, prepared.characterId), prepared.characterId));
    }
    function compileCharacterRoute(state, item, targetCharacterId) {
        const source = locatePlannerItem(state, item);
        if (source?.location.container === 'characterInventory' && source.location.characterId === targetCharacterId)
            return EMPTY_PLAN;
        if (source?.location.container === 'vault')
            return series(ensureCharacterBucketSpace(state, targetCharacterId, source.item.bucketHash, [item]), transferFromVaultStep(referenceFromPlannerItem(source.item), targetCharacterId));
        const prepared = prepareMovableCharacterInventorySource(state, item, source);
        if (!prepared.characterId)
            throw new TransferPlannerError('Unable to transfer item: Character required', 'stale-location');
        return series(prepared.plan, ensureVaultSpace(state), transferToVaultStep(referenceFromPlannerItem(prepared.item, prepared.characterId), prepared.characterId), ensureCharacterBucketSpace(state, targetCharacterId, prepared.item.bucketHash, [item]), transferFromVaultStep(referenceFromPlannerItem(prepared.item), targetCharacterId));
    }
    function compileEquipRoute(state, item, targetCharacterId) {
        const source = locatePlannerItem(state, item);
        if (source?.location.container === 'characterEquipment' && source.location.characterId === targetCharacterId)
            return EMPTY_PLAN;
        if (source?.location.container === 'vault')
            return series(parallel(ensureCharacterBucketSpace(state, targetCharacterId, source.item.bucketHash, [item]), ensureExoticConflictCleared(state, targetCharacterId, source.item, [item])), transferFromVaultStep(referenceFromPlannerItem(source.item), targetCharacterId), equipOnCharacterStep(referenceFromPlannerItem(source.item, targetCharacterId), targetCharacterId));
        const prepared = prepareMovableCharacterInventorySource(state, item, source);
        if (!prepared.characterId)
            throw new TransferPlannerError('Unable to transfer item: Character required', 'stale-location');
        ...
        if (prepared.characterId === targetCharacterId)
            return series(prepared.plan, ensureExoticConflictCleared(state, targetCharacterId, prepared.item, [item]), equipOnCharacterStep(preparedReference, targetCharacterId));
        return series(prepared.plan, ensureVaultSpace(state), transferToVaultStep(preparedReference, prepared.characterId), parallel(ensureCharacterBucketSpace(state, targetCharacterId, prepared.item.bucketHash, [item]), ensureExoticConflictCleared(state, targetCharacterId, prepared.item, [item])), transferFromVaultStep(referenceFromPlannerItem(prepared.item), targetCharacterId), equipOnCharacterStep(referenceFromPlannerItem(prepared.item, targetCharacterId), targetCharacterId));
    }
    function prepareMovableCharacterInventorySource(state, reference, source) {
        if (reference.isLostItem) {
            ...
            return {
                ...
                plan: series(ensureCharacterBucketSpace(state, reference.characterId, item.bucketHash, [reference]), pullPostmasterStep(reference, reference.characterId, item.bucketHash)),
            };
        }
        if (!source)
    ...
    function ensureCharacterBucketSpace(state, characterId, bucketHash, excluded = []) {
        ...
        return series(ensureVaultSpace(state), transferToVaultStep(referenceFromPlannerItem(candidate, characterId), characterId));
    }
    function ensureVaultSpace(state) {
        if (countVaultItems(state) < bucketCapacity(state, 138197802 /* InventoryBucketHashes.General */))
            return EMPTY_PLAN;
        throw new TransferPlannerError('Unable to transfer item: Vault full', 'bucket-full');
    }
    function ensureExoticConflictCleared(state, characterId, incoming, excluded = []) {
    ...
    function releaseEquippedSourceStep(state, characterId, source, excluded = []) {
        return equipFallbackForBucket(state, characterId, source.bucketHash, [...excluded, referenceFromPlannerItem(source, characterId)]);
    }
    function equipFallbackForBucket(state, characterId, bucketHash, excluded) {
        ...
        switch (candidate.location.container) {
            case 'characterInventory':
                ...
                return series(ensureVaultSpace(state), transferToVaultStep(referenceFromPlannerItem(candidate.item, candidate.location.characterId), candidate.location.characterId), ensureCharacterBucketSpace(state, characterId, bucketHash, excluded), transferFromVaultStep(referenceFromPlannerItem(candidate.item), characterId), equipOnCharacterStep(referenceFromPlannerItem(candidate.item, characterId), characterId));
            case 'vault':
                return series(ensureCharacterBucketSpace(state, characterId, bucketHash, excluded), transferFromVaultStep(referenceFromPlannerItem(candidate.item), characterId), equipOnCharacterStep(referenceFromPlannerItem(candidate.item, characterId), characterId));
            case 'characterEquipment':
                return series(releaseEquippedSourceStep(state, candidate.location.characterId, candidate.item, excluded), ensureVaultSpace(state), transferToVaultStep(referenceFromPlannerItem(candidate.item, candidate.location.characterId), candidate.location.characterId), ensureCharacterBucketSpace(state, characterId, bucketHash, excluded), transferFromVaultStep(referenceFromPlannerItem(candidate.item), characterId), equipOnCharacterStep(referenceFromPlannerItem(candidate.item, characterId), characterId));
            default:
                throw new TransferPlannerError('Unable to equip fallback item: Unsupported fallback source', 'equip-restriction');
        }
    }
    function fallbackCandidates(state, characterId, bucketHash, excluded) {
        const legal = (located) => located.item.bucketHash === bucketHash
            && !!located.item.id
            && !isReservedOrExcluded(state, located.item, excluded)
            && isCharacterLegalForItem(state, characterId, located.item);
        const preferLegendary = (a, b) => Number(isExotic(state, a.item)) - Number(isExotic(state, b.item));
        const character = state.inventory.characters[characterId];
        const sameCharacter = character?.items
            .map(item => ({ item, location: { container: 'characterInventory', characterId } }))
            .filter(legal)
            .sort(preferLegendary) ?? [];
        const vault = state.inventory.profileItems
            .map(item => ({ item, location: { container: 'vault' } }))
            .filter(legal)
            .sort(preferLegendary);
        ...
        const otherInventory = otherCharacters
            .flatMap(character => character.items.map(item => ({ item, location: { container: 'characterInventory', characterId: character.id } })))
            .filter(legal)
            .sort(preferLegendary);
        const otherEquipment = otherCharacters
            .flatMap(character => character.equippedItems.map(item => ({ item, location: { container: 'characterEquipment', characterId: character.id } })))
            .filter(legal)
            .sort(preferLegendary);
        return [
            ...sameCharacter,
    ...
    function transferToVaultStep(item, characterId) {
        return step({
    ...
    function transferFromVaultStep(item, characterId) {
        return step({
    ...
    function pullPostmasterStep(item, characterId, bucketHash) {
        return step({
    ...
    function equipOnCharacterStep(item, characterId) {
        return step({
            label: 'equip-item',
            async execute(state) {
    ...
    function transferBody(profile, item, characterId, transferToVault) {
        return {
            membershipType: profile.type,
            itemId: item.instanceId ?? '0',
            itemReferenceHash: item.itemHash,
    ...
    async function transferPatchesForBody(body) {
        const itemInventoryBucket = await getItemInventoryBucket(body.itemReferenceHash);
        if (itemInventoryBucket?.isAccountScopedTransferBucket)
            return [{
                    type: 'bucket-correction',
    ...
    function applyPlannerPatches(state, patches) {
            ...
            switch (patch.type) {
                case 'move': {
                    ...
                    const bucketHash = patch.to.container === 'vault'
                        ? 138197802 /* InventoryBucketHashes.General */
                    ...
                    destination.push({ ...item, bucketHash: bucketHash });
                    break;
                }
    ...
    function locatePlannerItem(state, reference) {
    ...
    function plannerLocationItems(state, location) {
        switch (location.container) {
            case 'vault':
    ...
    function countCharacterBucketItems(state, characterId, bucketHash) {
        return state.inventory.characters[characterId]?.items.filter(item => item.bucketHash === bucketHash).length ?? Infinity;
    }
    function countVaultItems(state) {
        return state.inventory.profileItems.filter(item => item.bucketHash === 138197802 /* InventoryBucketHashes.General */).length;
    }
    function bucketCapacity(state, bucketHash) {
        return state.bucketDefs[bucketHash]?.itemCount ?? Infinity;
    }
    function syntheticPlannerItem(state, reference) {
        const bucketHash = reference.bucketHash ?? state.itemDefs[reference.itemHash]?.inventory?.bucketTypeHash ?? 138197802 /* InventoryBucketHashes.General */;
        return {
            is: 'item-instance',
    ...
    function referenceFromPlannerItem(item, characterId) {
        return {
            instanceId: item.id,
            itemHash: item.itemHash,
            characterId,
    ...
    function isReservedOrExcluded(state, item, excluded) {
    ...
    function isCharacterLegalForItem(state, characterId, item) {
    ...
    function isExotic(state, item) {
        return state.itemDefs[item.itemHash]?.inventory?.tierType === 6 /* TierType.Exotic */;
    }
    function uniqueEquipLabel(state, item) {
        return state.itemDefs[item.itemHash]?.equippingBlock?.uniqueLabel;
    }
    async function executePlannedTransfer(origin, operationId, options, compile, actions) {
        const auth = await Auth_2.default.getValid();
        const profile = await Profiles_1.default.getCurrentProfile(auth);
        if (!profile) {
            Broadcast_10.default.warning('user', 'Unable to transfer item: Not authenticated');
            return [];
        }
    ...
    (function (ItemTransfer) {
        async function vaultItem(origin, item, options = {}) {
            ...
            return await Broadcast_10.default.operation('Vaulting item', [relatedItem(item), ...relatedCharacter(item.characterId)], async () => await runTransferOperation(origin, id, 'vault-item', options, async () => await executePlannedTransfer(origin, id, options, state => compileVaultRoute(state, item), [
                { item, to: 'vault' },
            ])));
        }
        ItemTransfer.vaultItem = vaultItem;
        async function moveItemToCharacter(origin, characterId, item, options = {}) {
            const id = options.operationId ?? operationId();
            await broadcastIntent(origin, {
                operationId: id,
            ...
            return await Broadcast_10.default.operation('Moving item to character', [relatedItem(item), ...relatedCharacter(characterId)], async () => await runTransferOperation(origin, id, 'move-item-to-character', options, async () => await executePlannedTransfer(origin, id, options, state => compileCharacterRoute(state, item, characterId), [
                { item, to: 'character', newCharacterId: characterId },
            ])));
        }
        ItemTransfer.moveItemToCharacter = moveItemToCharacter;
        async function equipItemOnCharacter(origin, characterId, item, options = {}) {
            const id = options.operationId ?? operationId();
            await broadcastIntent(origin, {
                operationId: id,
            ...
            return await runTransferOperation(origin, id, 'equip-item-on-character', options, async () => await executePlannedTransfer(origin, id, options, state => compileEquipRoute(state, item, characterId), [
                { item, to: 'equipped', newCharacterId: characterId },
            ]));
        }
        ItemTransfer.equipItemOnCharacter = equipItemOnCharacter;
...
define("model/Collections", ["require", "exports", "model/CombinedManifestVersion", "model/Definitions", "model/DestinyProfiles", "model/Items", "model/ProfiledModel", "utility/Broadcast"], function (require, exports, CombinedManifestVersion_1, Definitions_5, DestinyProfiles_2, Items_2, ProfiledModel_4, Broadcast_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Broadcast_11 = __importDefault(Broadcast_11);
    const version = `29.${Items_2.ITEMS_VERSION}`;
    function buckets() {
        return {
    ...
    exports.default = (0, ProfiledModel_4.ProfiledModel)('Collections', {
        cacheDirtyTime: 1000 * 60 * 1, // 1 minute cache time
        async fetch(profile) {
            ...
            return {
                ...
                value: async () => {
                    return await Broadcast_11.default.operation('Resolving collections', async () => {
                        const [DeepsightCollectionsDefinition, DeepsightMomentDefinition,] = await Promise.all([
                            Definitions_5.default.en.DeepsightCollectionsDefinition.get(),
                            Definitions_5.default.en.DeepsightMomentDefinition.get(),
                        ]);
                        const provider = await Items_2.default.provider(data, 'collections');
                        return {
                            ...{ version },
...
define("model/OfflineCache", ["require", "exports", "model/Collections", "model/CombinedManifestVersion", "model/Definitions", "model/DefinitionsComponentNames", "model/DestinyProfileFull", "model/Inventory", "model/Auth", "utility/Bungie", "utility/Database", "utility/Log", "utility/Network", "utility/Store"], function (require, exports, Collections_1, CombinedManifestVersion_2, Definitions_6, DefinitionsComponentNames_1, DestinyProfileFull_2, Inventory_2, Auth_3, Bungie_6, Database_5, Log_6, Network_7, Store_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    DestinyProfileFull_2 = __importDefault(DestinyProfileFull_2);
    Inventory_2 = __importDefault(Inventory_2);
    Auth_3 = __importDefault(Auth_3);
    Bungie_6 = __importDefault(Bungie_6);
    Log_6 = __importDefault(Log_6);
    Network_7 = __importDefault(Network_7);
    Store_8 = __importDefault(Store_8);
    ...
    (function (OfflineCache) {
        ...
        async function getState() {
            const [run, progress, summary] = await Promise.all([
                Store_8.default.offlineCacheRun.get(),
                Store_8.default.offlineCacheProgress.get(),
                Store_8.default.offlineCacheSummary.get(),
            ]);
            return { run, progress, summary };
        }
        OfflineCache.getState = getState;
        async function clear() {
            if (activeRun)
                throw new Error('Cannot clear offline cache while a cache run is active');
            await Database_5.db.transaction('rw', Database_5.db.data, Database_5.db.versions, async (db) => {
            ...
            await Promise.all([
                Store_8.default.offlineCacheRun.delete(),
                Store_8.default.offlineCacheProgress.delete(),
                Store_8.default.offlineCacheSummary.delete(),
            ]);
        }
        OfflineCache.clear = clear;
        async function start(progressCallback, completeCallback) {
            if (activeRun)
            ...
            await Store_8.default.offlineCacheRun.set(state);
            const promise = runInner(state, progressCallback)
                .then(async (summary) => {
                const completedState = { ...state, running: false };
                await Store_8.default.offlineCacheRun.set(completedState);
                await completeCallback(summary);
                return summary;
            })
                .catch(async (err) => {
                await Store_8.default.offlineCacheRun.set({ ...state, running: false });
                throw err;
            })
                .finally(() => activeRun = undefined);
            activeRun = { state, promise };
            void promise.catch(err => Log_6.default.warn('Offline cache failed', state.runId, err));
            return state;
        }
        OfflineCache.start = start;
        async function runInner(run, progressCallback) {
            const counts = emptyCounts();
            const failures = [];
            const pgcrIds = new Set();
            let lastProgressPersist = 0;
            const progress = async (stage, label, current, total, detail) => {
                const payload = {
                    runId: run.runId,
                    stage,
                    label,
                ...
                Log_6.default.info('Offline cache progress', run.runId, stage, `${current}/${total ?? '?'}`, detail ?? label);
                const shouldPersist = stage !== 'pgcr' || Date.now() - lastProgressPersist > 1000 || current === total;
                if (shouldPersist) {
                    lastProgressPersist = Date.now();
                    await Store_8.default.offlineCacheProgress.set(payload);
                }
                await progressCallback(payload);
            };
            const fail = (stage, key, err) => {
                const failure = {
                    stage,
                    key,
                ...
                Log_6.default.warn('Offline cache failure', run.runId, stage, key, failure.message);
            };
            await progress('versions', 'Checking cached versions', 0, 1);
            await (0, CombinedManifestVersion_2.getVersions)()
                .catch(err => fail('versions', 'versions', err));
            const componentNames = await DefinitionsComponentNames_1.default.get()
                .catch(err => {
            ...
            await parallelLimit(componentNames, DEFINITION_CONCURRENCY, async (componentName) => {
                await getDefinitionModel(componentName).get()
                    ...
                    .catch((err) => fail('definitions', componentName, err));
                definitionsComplete++;
            ...
            for (let i = 0; i < profiles.length; i++) {
                ...
                await DestinyProfileFull_2.default.for(profile).get()
            ...
            for (let i = 0; i < profiles.length; i++) {
                ...
                await Inventory_2.default.for(profile).get()
            ...
            for (let i = 0; i < profiles.length; i++) {
                ...
                await Collections_1.default.for(profile).get()
            ...
            await Store_8.default.offlineCacheSummary.set(summary);
            await progress('complete', 'Offline cache complete', 1, 1, `${counts.pgcrsDownloaded} PGCRs downloaded`);
            return summary;
        }
        async function getProfiles(fail) {
            const profiles = await Database_5.db.profiles.toArray();
            const auth = await Auth_3.default.getValid().catch(err => {
                fail('profiles', 'auth', err);
                return undefined;
            });
            const current = auth?.profileId
                ? await Database_5.db.profiles.get(auth.profileId).catch(err => {
        ...
        async function cacheActivityHistory(profile, characterId, counts, fail) {
            const key = activityHistoryKey(profile, characterId);
            const cached = await getCachedData(key);
            const activities = [];
            try {
                for (let page = 0;; page++) {
                    const result = await Bungie_6.default.getForUser(`/Destiny2/${profile.type}/Account/${profile.id}/Character/${characterId}/Stats/Activities/`, {
        ...
        async function cachePgcrs(pgcrIds, counts, fail, progress) {
            let cursor = 0;
            let completed = 0;
        ...
        async function cachePgcr(pgcrId, counts, fail) {
            const key = pgcrKey(pgcrId);
            if (await getCachedData(key)) {
                counts.pgcrsCached++;
                return;
            }
            const unavailableKey = pgcrUnavailableKey(pgcrId);
            if (await getCachedData(unavailableKey)) {
        ...
        async function fetchPgcr(pgcrId) {
            const headers = await Auth_3.default.getHeaders();
            const response = await Network_7.default.fetch(`${PGCR_ORIGIN}/${pgcrId}/`, { headers: { ...headers } });
            const json = await response.json().catch(() => undefined);
            if (!response.ok || !json)
                throw Object.assign(new Error(response.statusText || 'Unable to fetch PGCR'), { code: response.status });
            if (json.ErrorCode && json.ErrorCode !== 1 /* PlatformErrorCodes.Success */)
        ...
        OfflineCache.fetchPgcr = fetchPgcr;
        async function getCachedData(component) {
            return await Database_5.db.data.get(component).then(data => data?.data);
        }
        OfflineCache.getCachedData = getCachedData;
        async function putCachedData(component, data) {
            await Database_5.db.data.put({ component, data });
        }
        OfflineCache.putCachedData = putCachedData;
        ...
        function activityHistoryKey(profile, characterId) {
            return `destiny2/activity-history:${profile.type}/${profile.id}/${characterId}`;
        }
        OfflineCache.activityHistoryKey = activityHistoryKey;
        function pgcrKey(pgcrId) {
            return `destiny2/pgcr:${pgcrId}`;
        }
        OfflineCache.pgcrKey = pgcrKey;
        function pgcrUnavailableKey(pgcrId) {
            return `destiny2/pgcr-unavailable:${pgcrId}`;
        }
        OfflineCache.pgcrUnavailableKey = pgcrUnavailableKey;
        function errorMessage(err) {
            return err instanceof Error ? err.message : String(err);
        }
        OfflineCache.errorMessage = errorMessage;
        function isUnavailablePgcr(err) {
        ...
        OfflineCache.isUnavailablePgcr = isUnavailablePgcr;
        function getDefinitionModel(componentName) {
            return Definitions_6.default.en[componentName];
        }
    })(OfflineCache || (OfflineCache = {}));
    exports.default = OfflineCache;
});
define("model/Pgcrs", ["require", "exports", "model/OfflineCache", "utility/Bungie"], function (require, exports, OfflineCache_1, Bungie_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    OfflineCache_1 = __importDefault(OfflineCache_1);
    Bungie_7 = __importDefault(Bungie_7);
    const ACTIVITY_PAGE_SIZE = 250;
    const MAX_PAGE_SIZE = 250;
    var Pgcrs;
    (function (Pgcrs) {
        async function get(profile, pageSize = MAX_PAGE_SIZE, page = 0) {
            ...
            const sources = await Promise.all(profile.characters.map(character => getActivitySource(profile, character.id, requiredActivities)));
            const allActivities = sources
                .flatMap(source => source.activities.map(activity => ({ characterId: source.characterId, activity })))
        ...
        Pgcrs.get = get;
        async function getActivitySource(profile, characterId, requiredActivities) {
            const key = OfflineCache_1.default.activityHistoryKey(profile, characterId);
            const cached = await OfflineCache_1.default.getCachedData(key);
            if (cached)
                return {
                    characterId,
            ...
            for (let page = 0; activities.length < requiredActivities; page++) {
                const result = await Bungie_7.default.getForUser(`/Destiny2/${profile.type}/Account/${profile.id}/Character/${characterId}/Stats/Activities/`, {
                    count: ACTIVITY_PAGE_SIZE,
                    page,
                });
                const pageActivities = result?.activities ?? [];
                activities.push(...pageActivities);
                if (pageActivities.length < ACTIVITY_PAGE_SIZE) {
                    await OfflineCache_1.default.putCachedData(key, {
                        cachedAt: new Date().toISOString(),
                        activities,
                    });
                    return {
        ...
        async function toPgcrEntry({ characterId, activity }) {
            const pgcrId = activity.activityDetails.instanceId;
            const key = OfflineCache_1.default.pgcrKey(pgcrId);
            const cached = await OfflineCache_1.default.getCachedData(key);
            if (cached)
                return {
                    characterId,
            ...
            const unavailableKey = OfflineCache_1.default.pgcrUnavailableKey(pgcrId);
            const unavailable = await OfflineCache_1.default.getCachedData(unavailableKey);
            if (unavailable)
                return {
                    characterId,
                    activity,
            ...
            try {
                const pgcr = await OfflineCache_1.default.fetchPgcr(pgcrId);
                await OfflineCache_1.default.putCachedData(key, pgcr);
                return {
                    characterId,
                    activity,
                    pgcr,
                ...
                const message = OfflineCache_1.default.errorMessage(err);
                if (OfflineCache_1.default.isUnavailablePgcr(err)) {
                    await OfflineCache_1.default.putCachedData(unavailableKey, {
                        unavailable: true,
                        cachedAt: new Date().toISOString(),
                        message,
                    });
...
define("utility/ImageCategorisation", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.discoverDefinitionImages = discoverDefinitionImages;
    exports.imageCategoriesMatch = imageCategoriesMatch;
    exports.toDefinitionImage = toDefinitionImage;
    exports.getImageLayout = getImageLayout;
    exports.canonicaliseImageUrl = canonicaliseImageUrl;
    exports.imageHash = imageHash;
    const BUNGIE_ORIGIN = 'https://www.bungie.net';
    const imageHashCache = new Map();
    async function discoverDefinitionImages(component, definition, data, deepsightImageBaseUrl) {
        const images = [];
    ...
    function imageCategoriesMatch(image, categories) {
        if (!categories.length)
            return true;
        return categories.every(category => image.categories.includes(category));
    }
    function toDefinitionImage(image) {
        return {
    ...
    function getImageLayout(images, filtered) {
        if (!filtered)
    ...
    function canonicaliseImageUrl(raw, deepsightImageBaseUrl) {
        raw = raw.trim();
        if (!raw)
            return undefined;
        try {
    ...
    async function imageHash(canonicalUrl) {
    ...
    function getImageCategories(sourceCategory, analysis) {
        const categories = new Set();
        if (analysis?.[sourceCategory])
            categories.add(sourceCategory);
        if (analysis)
            for (const [category, matched] of Object.entries(analysis))
                if (matched)
                    categories.add(Number(category));
        return Array.from(categories).sort((a, b) => a - b);
    }
    function getPathValues(value, sourcePath) {
        let values = [value];
    ...
    function dedupeImages(images) {
        const canonicalDeduped = new Map();
    ...
    function mergeImages(existing, image) {
        return {
            ...existing,
    ...
    function getCategoryFraming(categoryDefinition) {
        return categoryDefinition.framing ?? 1 /* DefinitionImageFraming.Complete */;
    }
    function mergeImageFraming(a, b) {
        return a === 1 /* DefinitionImageFraming.Complete */ || b === 1 /* DefinitionImageFraming.Complete */
            ? 1 /* DefinitionImageFraming.Complete */
            : 0 /* DefinitionImageFraming.CropSafe */;
    }
...
define("Conduit", ["require", "exports", "action/ItemTransfer", "model/Auth", "model/Collections", "model/CombinedManifestVersion", "model/Definitions", "model/DefinitionsComponentNames", "model/Inventory", "model/OfflineCache", "model/Pgcrs", "model/Profiles", "utility/Database", "utility/Env", "utility/FilterHelper", "utility/ImageCategorisation", "utility/Log", "utility/Service", "utility/Store"], function (require, exports, ItemTransfer_1, Auth_4, Collections_2, CombinedManifestVersion_3, Definitions_7, DefinitionsComponentNames_2, Inventory_3, OfflineCache_2, Pgcrs_1, Profiles_2, Database_6, Env_3, FilterHelper_1, ImageCategorisation_1, Log_7, Service_2, Store_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ItemTransfer_1 = __importDefault(ItemTransfer_1);
    Auth_4 = __importDefault(Auth_4);
    Collections_2 = __importDefault(Collections_2);
    Definitions_7 = __importDefault(Definitions_7);
    DefinitionsComponentNames_2 = __importDefault(DefinitionsComponentNames_2);
    Inventory_3 = __importDefault(Inventory_3);
    OfflineCache_2 = __importDefault(OfflineCache_2);
    Pgcrs_1 = __importDefault(Pgcrs_1);
    Profiles_2 = __importDefault(Profiles_2);
    Env_3 = __importDefault(Env_3);
    FilterHelper_1 = __importDefault(FilterHelper_1);
    Log_7 = __importDefault(Log_7);
    Service_2 = __importStar(Service_2);
    Store_9 = __importStar(Store_9);
    ...
    const service = (0, Service_2.default)({
        ...
        onCall: {
            ...
            async getProfile(event, displayName, displayNameCode) {
                ...
                if (!profile || await Auth_4.default.getOriginAccess(event.origin))
                    return profile;
            ...
            async getCollections(event, displayName, displayNameCode) {
                const profile = _
                    ...
                    ?? await Profiles_2.default.getCurrentProfile(await Auth_4.default.getValid());
                return await Collections_2.default.for(profile).get();
            },
            async getCollectionsVersioned(event, displayName, displayNameCode, cacheVersion) {
                const profile = _
                    ?? (!displayName || !displayNameCode ? undefined : await this.getProfile(event, displayName, displayNameCode))
                    ?? await Profiles_2.default.getCurrentProfile(await Auth_4.default.getValid());
                return await Collections_2.default.for(profile).getVersioned(cacheVersion);
            },
            async getInventory(event, displayName, displayNameCode) {
                ...
                const inventory = profile && await Inventory_3.default.for(profile).get();
            ...
            async getInventoryVersioned(event, displayName, displayNameCode, cacheVersion) {
                const profile = await this.getProfile(event, displayName, displayNameCode);
                return await Inventory_3.default.for(profile).getVersioned(cacheVersion);
            },
            async getInventoryCached(event, displayName, displayNameCode) {
                const profile = await this.getProfile(event, displayName, displayNameCode);
                if (!profile)
                    return undefined;
                return await Inventory_3.default.for(profile).getCached(inventory => broadcastInventoryUpdated(event, profile, inventory));
            },
            async getInventoryCachedVersioned(event, displayName, displayNameCode, cacheVersion) {
                ...
                return await Inventory_3.default.for(profile).getCachedVersioned(cacheVersion, inventory => broadcastInventoryUpdated(event, profile, inventory));
            },
            async getPgcrs(event, displayName, displayNameCode, pageSize, page) {
                ...
                if (!profile?.authed)
                    return undefined;
                return await Pgcrs_1.default.get(profile, pageSize, page);
            },
            async vaultItem(event, item, options) {
                await Auth_4.default.assertOriginAccess(event.origin);
                return ItemTransfer_1.default.vaultItem(event.origin, item, options);
            },
            async moveItemToCharacter(event, characterId, item, options) {
                await Auth_4.default.assertOriginAccess(event.origin);
                return ItemTransfer_1.default.moveItemToCharacter(event.origin, characterId, item, options);
            },
            async equipItemOnCharacter(event, characterId, item, options) {
                await Auth_4.default.assertOriginAccess(event.origin);
                return ItemTransfer_1.default.equipItemOnCharacter(event.origin, characterId, item, options);
            },
            async getComponentNames() {
                return await DefinitionsComponentNames_2.default.get();
            },
            ...
            async _getOfflineCacheState(event) {
                ...
                return await OfflineCache_2.default.getState();
            },
            async _clearOfflineCache(event) {
                assertOwnOrigin(event.origin);
                await OfflineCache_2.default.clear();
            },
            async _cacheOfflineData(event) {
                assertOwnOrigin(event.origin);
                return await OfflineCache_2.default.start(async (progress) => {
                    await service.broadcast.offlineCacheProgress(origin => origin === event.origin ? progress : Service_2.SKIP_CLIENT);
                }, async (summary) => {
                    await service.broadcast.offlineCacheComplete(origin => origin === event.origin ? summary : Service_2.SKIP_CLIENT);
                });
            },
            ////////////////////////////////////
            //#region Private
            ...
            async _getSetting(event, key) {
                assertOwnOrigin(event.origin);
                return await Store_9.default[key].get();
            },
            async _setSetting(event, key, value) {
                assertOwnOrigin(event.origin);
                await Store_9.default[key].set(value);
            },
            async _resetSetting(event, key) {
                assertOwnOrigin(event.origin);
                await Store_9.default[key].delete();
            },
            //#endregion
            ////////////////////////////////////
            setOrigin(event) { },
            async _getAuthState(event) {
                assertOwnOrigin(event.origin);
                return await Auth_4.default.getAuthState();
            },
            async _setCustomApp(event, app) {
                assertOwnOrigin(event.origin);
                if (app)
                    await Store_9.default.customApp.set(app);
                else
                    await Store_9.default.customApp.delete();
                await Store_9.default.auth.delete(); // must re-auth when changing app
            },
            async _authenticate(event, code) {
                assertOwnOrigin(event.origin);
                const authed = !!await Auth_4.default.complete(code);
                if (authed)
            ...
            async _grantAccess(event, origin, appName) {
                assertOwnOrigin(event.origin);
                const granted = await Auth_4.default.grantAccess(origin, appName);
                if (granted) {
            ...
            async _denyAccess(event, origin) {
                assertOwnOrigin(event.origin);
                return await Auth_4.default.denyAccess(origin);
            },
            ////////////////////////////////////
            //#region Defs
            async _getDefinition(event, language, component, hash) {
                const defs = await Definitions_7.default[language][component].get();
                return defs[hash];
            },
            async _getDefinitionsComponent(event, language, component, filter) {
                if (filter?.evalExpression && !await Auth_4.default.isOriginTrusted(event.origin))
                    throw new ConduitFunctionRequiresTrustedOriginError();
                // filter.evalExpression = undefined
                let defs = await Definitions_7.default[language][component].get();
                if (!filter || !hasDefinitionsFilter(filter))
                    return defs;
                if (hasTextDefinitionsFilter(filter))
                    defs = Object.fromEntries(FilterHelper_1.default.filter(defs, filter));
                if (filter.imageCategories?.length)
                    defs = await filterDefinitionsByImageCategories(language, component, defs, filter.imageCategories);
                return defs;
            },
            ////////////////////////////////////
            ...
            async _getDefinitionsComponentPage(event, language, component, pageSize, page, filter) {
                ...
                if (filter && hasTextDefinitionsFilter(filter)) {
                    ...
                    defs = Object.fromEntries(imageFiltered
                        ? FilterHelper_1.default.filter(defs, filter)
                        : FilterHelper_1.default.filter(defs, filter).drop(page * pageSize).take(pageSize + 1));
                }
                if (imageFiltered) {
                    filtered = true;
                    defs = await filterDefinitionsByImageCategories(language, component, defs, imageCategories);
                }
            ...
            async _getDefinitionsComponentImagePage(event, language, component, pageSize, page, filter) {
                if (page < 0 || pageSize <= 0)
                    return {
                        definitions: {},
                        images: {},
                        layout: (0, ImageCategorisation_1.getImageLayout)([], false),
                        page,
                        pageSize,
                        totalPages: 0,
                        totalDefinitions: 0,
                ...
                const rawEntries = Object.entries(defs)
                ...
                if (!imageFiltered) {
                    ...
                    return {
                        definitions: Object.fromEntries(pageEntries),
                        images: Object.fromEntries(entriesWithImages.map(([key, , images]) => [key, images.map(ImageCategorisation_1.toDefinitionImage)])),
                        layout: (0, ImageCategorisation_1.getImageLayout)(entriesWithImages.flatMap(([, , images]) => images), false),
                        page,
                        pageSize,
                        totalPages,
                ...
                const images = Object.fromEntries(pageEntries.map(([key, , images]) => [key, images.map(ImageCategorisation_1.toDefinitionImage)]));
                const layout = (0, ImageCategorisation_1.getImageLayout)(matchingEntries.flatMap(([, , images]) => images), imageFiltered);
                return {
            ...
            async _getDefinitionLinks(event, language, component, hash) {
                ...
                if (!def)
                    return undefined;
                const { components, enums } = await Definitions_7.default.en.DeepsightLinksDefinition.get();
                ...
                let definitions;
                let defsToGrab;
                const setAugmentation = (augmentationComponent, value) => {
                    augmentations ??= {};
                    augmentations[augmentationComponent] = value;
                };
                ...
                await Promise.all([
                    ...(linksDef.augmentations ?? [])
                        ...
                        const augmentationDefs = await Definitions_7.default[language][augmentationComponent].get();
                        const def = augmentationDefs?.[hash];
                        if (def && typeof def === 'object') {
                            setAugmentation(augmentationComponent, def);
                            return;
                        }
                        const augmentationLinksDef = components[augmentationComponent];
                        const augmentationLinksToComponent = augmentationLinksDef?.links?.filter((link) => !('enum' in link) && link.component === component);
                        if (!augmentationLinksToComponent?.length)
                            return;
                        const matchedAugmentations = [];
                        for (const [key, augmentationDef] of Object.entries(augmentationDefs)) {
                            if (!augmentationDef)
                                continue;
                    ...
                    component !== 'DestinyInventoryItemDefinition' ? undefined : (async () => {
                        const DeepsightVariantDefinition = await Definitions_7.default[language].DeepsightVariantDefinition.get();
                        ...
                        await Promise.all(variants.map(async (variantEntry) => {
                            const defs = await Definitions_7.default[language].DestinyInventoryItemDefinition.get();
                            definitions ??= {};
            ...
            async _getDefinitionsReferencingPage(event, language, component, hash, pageSize, page) {
                const { components } = await Definitions_7.default.en.DeepsightLinksDefinition.get();
                ...
                const augmentationBaseComponents = new Map();
                for (const [baseComponent, linksDef] of Object.entries(components)) {
                ...
                const getDefs = (component) => {
                    let defs = defsCache.get(component);
                    if (!defs) {
                        defs = Definitions_7.default[language][component].get();
                ...
                const addResult = (component, key, def) => {
    ...
    function assertOwnOrigin(origin) {
    ...
    async function getState(event, hard) {
        const [version, profiles] = await Promise.all([
            (0, CombinedManifestVersion_3.getVersions)(hard),
            getProfiles(event),
        ]);
        return {
            version,
    ...
    async function getProfiles(event) {
        void updateProfiles();
        const profiles = (await Database_6.db.profiles.toArray())
    ...
    async function updateProfiles(forceOriginUpdate) {
        let [{ profiles, updated }, auth] = await Promise.all([
            ...
            Auth_4.default.getValid().catch(err => {
                Log_7.default.warn('Unable to validate Bungie.net auth while updating profiles', err);
                return undefined;
            }),
        ]);
        ...
        if (updated)
            void Database_6.db.profiles.bulkPut(profiles);
    ...
    async function definitionMatchesImageCategories(component, definition, imageCategories, imageData) {
        const images = await (0, ImageCategorisation_1.discoverDefinitionImages)(component, definition, imageData, getDeepsightImageBaseUrl());
        for (const image of images) {
            if ((0, ImageCategorisation_1.imageCategoriesMatch)(image, imageCategories))
                return true;
        }
        return false;
    }
    async function getDefinitionEntriesImages(component, entries, imageData, imageCategories) {
    ...
    async function getMatchingDefinitionImages(component, definition, imageData, imageCategories) {
        return (await (0, ImageCategorisation_1.discoverDefinitionImages)(component, definition, imageData, getDeepsightImageBaseUrl()))
            .filter(image => (0, ImageCategorisation_1.imageCategoriesMatch)(image, imageCategories));
    }
    async function getImageDefinitionData(language) {
        const definitions = Definitions_7.default[language];
    ...
    function getDeepsightImageBaseUrl() {
        return Env_3.default.LOCAL_DEEPSIGHT_MANIFEST_ORIGIN || 'https://deepsight.gg';
    }
    function broadcastInventoryUpdated(event, profile, inventory) {
        if (!inventory)
            return;
...
define("model/ItemLocations", ["require", "exports", "model/DestinyProfiles", "model/ProfiledModel"], function (require, exports, DestinyProfiles_3, ProfiledModel_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    DestinyProfiles_3 = __importDefault(DestinyProfiles_3);
    const ItemLocations = (0, ProfiledModel_5.ProfiledModel)('ItemLocations', {
        cacheDirtyTime: 1000 * 10, // 10 second cache time
        async fetch(profile) {
