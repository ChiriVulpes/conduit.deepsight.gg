...
define("utility/Log", ["require", "exports", "utility/Store"], function (require, exports, Store_1) {
    ...
    (function (Log) {
        ...
        function info(...args) {
            ...
            console[Log.VERBOSE.value ? 'info' : 'debug'](`%c${new Date().toTimeString().slice(0, 8)} %cconduit.deepsight.gg %c/`, 'color: #888;', 'color: #58946c;', 'color:#888;', ...args);
        }
        Log.info = info;
    })(Log || (Log = {}));
    exports.default = Log;
...
define("model/Profiles", ["require", "exports", "model/Definitions", "utility/Bungie", "utility/Colour", "utility/Database", "utility/Diff", "utility/Store"], function (require, exports, Definitions_1, Bungie_3, Colour_1, Database_3, Diff_1, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("model/Items", ["require", "exports", "model/Categorisation", "model/Definitions", "model/DestinyProfiles", "model/Profiles", "utility/Objects"], function (require, exports, Categorisation_1, Definitions_2, DestinyProfiles_1, Profiles_1, Objects_1) {
    ...
    (function (Items) {
        ...
        async function provider(type) {
            const [
            // ClarityDescriptions,
            DeepsightDropTableDefinition, DeepsightFormattedClarityDescriptions, DeepsightItemDamageTypesDefinition, DeepsightItemSourceDefinition, DeepsightItemSourceListDefinition, DeepsightMomentDefinition, DeepsightPlugCategorisation, DeepsightSocketCategorisation, DeepsightSocketExtendedDefinition, DeepsightTierTypeDefinition, DeepsightWeaponFoundryDefinition, DestinyDamageTypeDefinition, DestinyEquipableItemSetDefinition, DestinyInventoryItemDefinition, DestinyPlugSetDefinition, DestinyPresentationNodeDefinition, DestinySandboxPerkDefinition, DestinySocketCategoryDefinition, DestinyStatDefinition, DestinyStatGroupDefinition,] = await Promise.all([
                ...
                Definitions_2.default.en.DeepsightItemSourceDefinition.get(),
                ...
                Definitions_2.default.en.DeepsightTierTypeDefinition.get(),
                Definitions_2.default.en.DeepsightWeaponFoundryDefinition.get(),
                Definitions_2.default.en.DestinyDamageTypeDefinition.get(),
                ...
                Definitions_2.default.en.DestinyPresentationNodeDefinition.get(),
                Definitions_2.default.en.DestinySandboxPerkDefinition.get(),
                Definitions_2.default.en.DestinySocketCategoryDefinition.get(),
        ...
        async fetch() {
            return {
                ...
                value: async () => {
                    ...
                    const provider = await Items_1.default.provider('collections');
                    return {
                        ...{ version },
        ...
        onCall: {
            ...
            async _getDefinitionsComponentPage(event, language, component, pageSize, page, filter) {
                ...
                if (filter?.evalExpression && !await Auth_2.default.isOriginTrusted(event.origin))
                    throw new ConduitFunctionRequiresTrustedOriginError();
                // filter.evalExpression = undefined
                let defs = await Definitions_4.default[language][component].get();
                let filtered = false;
                if (filter && (filter.nameContainsOrHashIs || filter.deepContains || filter.jsonPathExpression || filter.evalExpression)) {
                    filtered = true;
            ...
            async _getDefinitionLinks(event, language, component, hash) {
                ...
                if (!def)
                    return undefined;
                const { components, enums } = await Definitions_4.default.en.DeepsightLinksDefinition.get();
                ...
                await Promise.all([
                    ...(linksDef.augmentations ?? [])
                        ...
                        const defs = await Definitions_4.default[language][augmentationComponent].get();
                        const def = defs?.[hash];
                        if (!def)
                            return;
                        augmentations ??= {};
                    ...
                    component !== 'DestinyInventoryItemDefinition' ? undefined : (async () => {
                        const DeepsightVariantDefinition = await Definitions_4.default[language].DeepsightVariantDefinition.get();
                        ...
                        await Promise.all(variants.map(async (variantEntry) => {
                            const defs = await Definitions_4.default[language].DestinyInventoryItemDefinition.get();
                            definitions ??= {};
            ...
            async _getDefinitionsReferencingPage(event, language, component, hash, pageSize, page) {
                const { components } = await Definitions_4.default.en.DeepsightLinksDefinition.get();
                ...
                await Promise.all(componentsReferencing.map(async ([referencingComponent, linksDef]) => {
                    ...
                    const defs = await Definitions_4.default[language][referencingComponent].get();
