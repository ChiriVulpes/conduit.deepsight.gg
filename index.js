    ...
    (function (Deepsight) {
        ...
        async function fetchTryLocalThenRemote(url) {
            if (Env_2.default.LOCAL_DEEPSIGHT_MANIFEST_ORIGIN) {
                const localResult = await self.fetch(`${Env_2.default.LOCAL_DEEPSIGHT_MANIFEST_ORIGIN}/docs/definitions${url}`)
...
define("model/DeepsightManifest", ["require", "exports", "model/Model", "utility/Deepsight"], function (require, exports, Model_2, Deepsight_1) {
    ...
    exports.default = (0, Model_2.default)('DeepsightManifest', {
...
define("Conduit", ["require", "exports", "model/Auth", "model/Collections", "model/Definitions", "model/Profiles", "utility/Database", "utility/Env", "utility/Service", "utility/Store"], function (require, exports, Auth_2, Collections_1, Definitions_4, Profiles_2, Database_4, Env_3, Service_1, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const service = (0, Service_1.default)({
        ...
        onCall: {
            ...
            async getProfiles() {
                void updateProfiles();
                return (await Database_4.db.profiles.toArray())
                    .sort((a, b) => +!!b.authed - +!!a.authed);
            },
            updateProfiles: () => updateProfiles(),
            async getProfile(event, displayName, displayNameCode) {
                return await Profiles_2.default.searchDestinyPlayerByBungieName(displayName, displayNameCode);
            },
            ...
            async _authenticate(event, code) {
                if (event.origin !== self.origin)
                    throw new ConduitPrivateFunctionError();
                return !!await Auth_2.default.complete(code);
            },
