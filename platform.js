...
define("component/core/Details", ["require", "exports", "kitsui"], function (require, exports, kitsui_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_10.Component)('details', (component) => {
        const summary = (0, kitsui_10.Component)('summary').style('details-summary');
        const content = (0, kitsui_10.Component)().style('details-content');
...
define("component/core/FormRow", ["require", "exports", "kitsui"], function (require, exports, kitsui_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const FormRow = (0, kitsui_11.Component)('label', (component) => {
        const label = (0, kitsui_11.Component)().style('form-row-label');
...
define("component/core/TextInput", ["require", "exports", "kitsui", "kitsui/utility/Applicator"], function (require, exports, kitsui_12, Applicator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Applicator_1 = __importDefault(Applicator_1);
    const TextInput = (0, kitsui_12.Component)('input', (component) => {
        let defaultValue = '';
        const state = (0, kitsui_12.State)(defaultValue);
...
define("component/MainCards", ["require", "exports", "component/core/ActionRow", "component/core/Button", "component/core/Card", "component/core/Details", "component/core/FormRow", "component/core/Loading", "component/core/Lore", "component/core/Paragraph", "component/core/TextInput", "kitsui", "Relic", "utility/Time"], function (require, exports, ActionRow_2, Button_2, Card_2, Details_1, FormRow_1, Loading_2, Lore_2, Paragraph_4, TextInput_1, kitsui_13, Relic_2, Time_2) {
    ...
    exports.default = (0, kitsui_13.Component)(component => {
        ...
        (0, Card_2.default)().appendTo(component).tweak(card => {
            ...
            (0, Loading_2.default)().appendTo(card).set(async (signal, setProgress) => {
                ...
                for (const grant of grants)
                    (0, kitsui_13.Component)('a')
                        .attributes.set('href', `${location.origin}${location.pathname}?auth=${encodeURIComponent(grant.origin)}`)
                        .style('grant')
                        .append((0, kitsui_13.Component)().style('grant-name').text.set(quilt => quilt['main/grants-card/grant-name'](grant.origin, grant.appName)))
        ...
        (0, Card_2.default)().appendTo(component).tweak(card => {
            ...
            (0, Details_1.default)()
                ...
                (0, Button_2.default)()
                    ...
                    .appendTo(actions);
                (0, Button_2.default)()
                    .tweak(button => button.bindDisabled(kitsui_13.State.Every(button, apiKeyInput.state, clientIdInput.state, clientSecretInput.state).falsy, 'missing input'))
...
define("component/WordmarkLogo", ["require", "exports", "kitsui"], function (require, exports, kitsui_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_14.Component)(component => {
        return component.style('wordmark-logo')
            .append((0, kitsui_14.Component)('img')
...
define("utility/Text", ["require", "exports", "kitsui", "kitsui/utility/StringApplicator", "lang"], function (require, exports, kitsui_15, StringApplicator_1, lang_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Text) {
        ...
        function renderWeft(weft) {
            ...
            if (Array.isArray(weft.content))
                ...
                else if (kitsui_15.Component.is(weft.content))
                ...
                for (let i = 0; i < texts.length; i++) {
                    if (i > 0)
                        element.append((0, kitsui_15.Component)('br').element, (0, kitsui_15.Component)().style('break').element);
        ...
        function createTagElement(tag) {
            ...
            if (tag.startsWith('link(')) {
                ...
                if (!href.startsWith('/') && !href.startsWith('.'))
                    href = `https://${href}`;
                return (0, kitsui_15.Component)('a')
            ...
            switch (tag) {
                ...
                case 'code': return (0, kitsui_15.Component)('code').style('code').element;
...
define("index", ["require", "exports", "component/AuthCard", "component/MainCards", "component/WordmarkLogo", "kitsui", "kitsui/utility/ActiveListener", "kitsui/utility/FocusListener", "kitsui/utility/HoverListener", "kitsui/utility/Mouse", "kitsui/utility/Viewport", "Relic", "utility/DevServer", "utility/Env", "utility/Text"], function (require, exports, AuthCard_1, MainCards_1, WordmarkLogo_1, kitsui_16, ActiveListener_1, FocusListener_1, HoverListener_1, Mouse_1, Viewport_1, Relic_3, DevServer_1, Env_2, Text_1) {
    ...
    async function default_1() {
        ...
        kitsui_16.Component.allowBuilding();
        Text_1.default.init();
        kitsui_16.Component.getBody().style('body');
        (0, kitsui_16.Component)('a')
...
define("component/core/Checkbox", ["require", "exports", "kitsui"], function (require, exports, kitsui_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Checkbox = (0, kitsui_17.Component)('label', (component) => {
        const label = (0, kitsui_17.Component)().style('checkbox-label');
        const checked = (0, kitsui_17.State)(false);
        const input = (0, kitsui_17.Component)('input')
