...
define("component/MainCards", ["require", "exports", "component/core/ActionRow", "component/core/Button", "component/core/Card", "component/core/Checkbox", "component/core/Details", "component/core/FormRow", "component/core/Loading", "component/core/Lore", "component/core/Paragraph", "component/core/TextInput", "kitsui", "Relic", "utility/Time"], function (require, exports, ActionRow_2, Button_2, Card_2, Checkbox_1, Details_1, FormRow_1, Loading_2, Lore_2, Paragraph_4, TextInput_1, kitsui_14, Relic_2, Time_2) {
        ...
        (0, Card_2.default)().appendTo(component).tweak(card => {
            ...
            (0, Details_1.default)()
                ...
                const verboseLoggingCheckbox = (0, Checkbox_1.default)()
                    ...
                    .appendTo(slot);
                const simulateOfflineApiCheckbox = (0, Checkbox_1.default)()
            ...
            (0, Details_1.default)()
                ...
                const running = (0, kitsui_14.State)(!!cacheState.run?.running);
                const progress = (0, kitsui_14.State)(cacheState.progress);
                const summary = (0, kitsui_14.State)(cacheState.summary);
                const error = (0, kitsui_14.State)(undefined);
                const cleared = (0, kitsui_14.State)(false);
                ...
                (0, Lore_2.default)()
                    .text.bind(kitsui_14.State.Map(slot, [running, summary, error, cleared], (running, summary, error, cleared) => quilt => {
                    if (running)
                        return quilt['main/advanced-card/offline-cache/status/running']();
                    if (summary)
                        return quilt['main/advanced-card/offline-cache/status/complete'](summary.counts.failures);
                    if (error)
                ...
                (0, Paragraph_4.default)()
                    ...
                    .text.bind(kitsui_14.State.Map(slot, [running, progress, summary], (running, progress, summary) => {
                    if (summary && !running)
                        return undefined;
                    return quilt => !progress || (!running && progress.stage === 'complete')
                        ? quilt['main/advanced-card/offline-cache/progress/idle']()
                        : quilt['main/advanced-card/offline-cache/progress/detail'](offlineCacheStageText(quilt, progress.stage), progress.current, progress.total, progress.detail);
                }))
                    .appendTo(slot);
                (0, Lore_2.default)()
                    .text.bind(progress.map(slot, progress => quilt => !progress
                    ? quilt['main/advanced-card/offline-cache/counts/empty']()
                    : quilt['main/advanced-card/offline-cache/counts/progress'](progress.counts.definitionsCached, progress.counts.activityHistoryActivities, progress.counts.pgcrsDiscovered, progress.counts.pgcrsDownloaded + progress.counts.pgcrsCached, progress.counts.pgcrsUnavailable, progress.counts.failures)))
                    .appendTo(slot);
                const actions = (0, ActionRow_2.default)().appendTo(slot);
                (0, Button_2.default)()
    ...
    function offlineCacheStageText(quilt, stage) {
        switch (stage) {
            case 'versions':
...
define("utility/Style", ["require", "exports", "kitsui/utility/StyleManipulator", "style", "utility/Script"], function (require, exports, StyleManipulator_1, style_1, Script_1) {
    ...
    (function (Style) {
        async function reload() {
            void reloadStylesheet('./style/index.css');
...
define("utility/Text", ["require", "exports", "kitsui", "kitsui/utility/StringApplicator", "lang"], function (require, exports, kitsui_16, StringApplicator_1, lang_1) {
    ...
    (function (Text) {
        ...
        function renderWeft(weft) {
            ...
            if (Array.isArray(weft.content))
                ...
                if (!lang_1.WeavingArg.isRenderable(weft.content)) {
                    ...
                    element.append(kitsui_16.Component.realise(weft.content));
                }
        ...
        function createStyledElement(tag, componentName) {
            return kitsui_16.Component.realise((0, kitsui_16.Component)(tag).style(componentName));
        }
    })(Text || (Text = {}));
